...
public class TipoNegocioServiceImpl implements TipoNegocioService{
	...
	@Override
	public LambdaResponse ObtenerTipoNegocio(LambdaRequest lambdaRequest) {
		...
		Map<String,Object> m=new HashMap<String,Object>();
		 ...
		 sql=" "
				  ...
				  +"from Maestros \r\n"
				  +"where NombreTabla = 'Tipo Negocio' \r\n"
				  +"and EstMaestro = '1' \r\n"
		  		;

	  List<Map<String, Object>> lstTipoNegocio = jdbcTemplate.queryForList(sql);
	  m.put("tiponegocio", lstTipoNegocio);
