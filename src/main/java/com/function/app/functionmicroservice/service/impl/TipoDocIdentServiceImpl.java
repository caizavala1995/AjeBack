...
@Service
public class TipoDocIdentServiceImpl implements TipoDocIdent{

	@Autowired
	private JdbcTemplate jdbcTemplate; 
	
	@Override
	public LambdaResponse ObtenerTipoDocIdent(LambdaRequest lambdaRequest) {
		...
		Map<String,Object> m=new HashMap<String,Object>();
		 ...
		 sql=" "
				  ...
				  +"from Maestros \r\n"
				  +"where NombreTabla = 'Tipo Documento Identidad' \r\n"
				  +"and EstMaestro = '1' \r\n"
		  		;

	  List<Map<String, Object>> lstTipoDocIdent = jdbcTemplate.queryForList(sql);
	  m.put("tipodocident", lstTipoDocIdent);
